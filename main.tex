...
We examine two cases: First, a case where the fitted lines are in local
...
lines both have $T_{ex}=T_{R}$.  Second, a case where the fitted lines are not
...
such values.  See Figure \ref{fig:nh3dtexsynthspecdemo} for an example of how
