...
\pyspeckit grew by incorporating new models such as xx and improving its
...
could in the future be handled by \texttt{specutils}) [I don't understand what
is meant by spectrum input and output here], the models in \pyspeckit
...
There is also the option to non-interactively fit a model to the many spectra in a
