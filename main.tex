...
spectral plotting, fitting, and general manipulation (Erik Tollerud's
\texttt{astropysics} was developed contemporaneously and solved many of the
same problems as \pyspeckit).  The \astropy project had its first commit in
