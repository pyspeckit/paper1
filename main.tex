...
\authorcomment1{Should we define GUI?}
...
\authorcomment1{is this only for continuum or it allows for normal baselining? 
If so, it is better to say baseline subtraction.}.
...
\begin{itemize}
	...
	\authorcomment1{What about citing 
	\url{http://adsabs.harvard.edu/abs/1981A&AS...44..363W}
	or 
	\url{http://adsabs.harvard.edu/abs/2002A&A...395.1061G?}}
	...
	Or up to which version of SDFITS it is working?}
...
\authorcomment1{this figure appears like a single column, but it uses the full page option, figure*. Is this what you want? I would place it as single column.}}
\label{fig:example1}
\end{figure*}
...
\authorcomment1{Add citation to GLUE paper?}
...
{\color{red}If this is the beefiest part of pyspeckit, we should include a table
...
\tablecolumns{4}
\tablecaption{Best fit parameters in optically thin model\label{table-thin}}
\tablehead{\colhead{Parameter} &\colhead{Input value} & \colhead{pyspeckit fit} & \colhead{CLASS fit}
}
\startdata
\cutinhead{With all 4 parameters}
T$_{ex}$ & 9.0 & 2.89591 & 2.88430952541\\  
$V_c$ & 0.0 & -0.000168891 &-0.004\\ 
$\sigma_v$ & 0.3 & 0.3033 &0.303207\\
$\tau_{all}$ & 0.01 & 0.450383 & 0.487 \\
$Area$ & & & 0.06108\\
\cutinhead{With all 3 parameters}
T$_{ex}$ & 9.0 & 3.42535  &  3.42094959703\\
$V_c$ & 0.0 & -0.00199191 &-0.004\\
$\sigma_v$ & 0.3 & 0.306108 &0.3066051\\
...
\begin{deluxetable}{cccc}
\tablecolumns{4}
\tablecaption{Best fit parameters in optically thick model\label{table-thick}}
\tablehead{\colhead{Parameter} &\colhead{Input value} & \colhead{pyspeckit fit} & \colhead{CLASS fit}
}
\startdata
\cutinhead{With all 4 parameters} 
T$_{ex}$ & 9.0 & 9.33 & 9.32310036\\
$V_c$ & 0.0 & -0.000168891 &-0.001\\ 
$\sigma_v$ & 0.3 & 0.29385 & 0.293440687\\
$\tau_{all}$ & 9.0 & 8.29 & 8.26 \\
$Area$ & & & 0.06108\\
\enddata
\end{deluxetable}
